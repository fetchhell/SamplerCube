...
class Config
{
  ...
  /*
   void initConfig(GLfloat min_filter, GLfloat mag_filter, GLfloat wrap_s, GLfloat wrap_t, bool generate_mipmaps)
   {
	   this->min_filter = min_filter; this->mag_filter = mag_filter; 
	   this->wrap_s = wrap_s;  this->wrap_t = wrap_t; this->generate_mipmaps = generate_mipmaps;
   }
   */
